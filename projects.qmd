...
López Durand, E., and Dickinson, K.. (forthcoming). Inclusive Morphology in Spanish: Processing and Learnability. *Studies in Hispanic and Lusophone Linguistics*.
...
Jaume-Losa, A. (accepted, May 2025). “From Left to Right”: the Influence of Political Orientation on the Language Attitudes of the Population of Palma de Mallorca toward Catalan and Spanish. *Studies in Hispanic and Lusophone Linguistics*.

Dickinson, Kendra V. (2024). Regularization and innovation: A usage-based approach to past participle variation in Brazilian Portuguese. *Languages, 9*(2), 52.
...
Dickinson, K., Schwenter, S., and McLean, C. (April 2024). Speaker Evaluations of Indirect Object (Non-)Doubling in Spanish: An Experimental Approach. *11th Internation
:::
